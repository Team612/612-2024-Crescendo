...
public class RobotContainer {
  ...
  private final RunOnTheFly m_runOnFlySpeaker = new RunOnTheFly(m_drivetrain, m_poseEstimator, m_traj, m_vision, 1.222);
  private final FeedForwardCharacterization m_characterization = new FeedForwardCharacterization(
            m_drivetrain,
            true,
  ...
  private void configureShuffleBoardBindings(){
    ...
    m_chooser.addOption("Speaker", new ProxyCommand(() -> m_runOnFlySpeaker));
    m_chooser.addOption("Swerve Characterization", new ProxyCommand(() -> m_characterization));
