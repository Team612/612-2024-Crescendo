    ...
    public PathPlannerTrajectory onthefly(PoseEstimator estimation, Vision vision, double y_translation){
        ...
        if(id == 6 || id == 7 || id == 8){
            ...
            return PathPlanner.generatePath(
                ...
                new PathPoint(new Translation2d(tagX, tagY - offset + y_translation), new Rotation2d(), new Rotation2d(Units.degreesToRadians(180)))
            );
        }
            ...
            return PathPlanner.generatePath(
                ...
                new PathPoint(new Translation2d(tagX, tagY - offset + y_translation), new Rotation2d(), new Rotation2d(Units.degreesToRadians(0)))
            );
        }
        else {
