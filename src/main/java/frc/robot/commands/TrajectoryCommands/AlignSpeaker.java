...
public class AlignSpeaker extends Command {
  ...
  public AlignSpeaker(Drivetrain d, PoseEstimator p, TrajectoryCreation traj, Vision v) {
  ...
  public void initialize() {
    PathPlannerPath path = m_traj.alignSpeaker(poseEstimatorSystem, m_vision);
